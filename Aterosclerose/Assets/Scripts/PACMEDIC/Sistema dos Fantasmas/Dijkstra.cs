...
// Certifique-se de ter a interface IShortestPathFinder implementada na Unity.

public class Dijkstra : MonoBehaviour, IShortestPathFinder
{
    ...
    class VisitingData
    {
        ...
        private readonly Dictionary<Node, Weight> _weights = new Dictionary<Node, Weight>();
